...
function Muscles() {
  const [forearms, setForearms] = useState('#595959')
  const [quads, setQuads] =  useState('#333')
  const [pecs, setPecs] =  useState('#595959')
  const [biceps, setBiceps] = useState('#404040')
  const [delts, setDelts] = useState('#333')
  const [triceps, setTriceps] = useState('#333')
  const [traps, setTraps] = useState('#262626')
  const [lats, setLats] = useState('#404040')
  const [abs, setAbs] = useState('#595959')
  const [obls, setObls] = useState('#262626')
  const [adds, setAdds] = useState('#4d4d4d')
  const [calves, setCalves] = useState('#4d4d4d')
  const [hams, setHams] = useState('#333')
  const [glutes, setGlutes] = useState('#1a1a1a')
