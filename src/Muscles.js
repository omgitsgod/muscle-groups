...
<div class="muscle-groups">
  ...
  <h2>Arms</h2>
  <input type="checkbox" checked={checks.get("biceps")} onChange={handleChange} class="biceps muscles-helper" id="biceps" /> <label for="biceps">Biceps</label>
  <input type="checkbox" checked={checks.get("deltoids")} onChange={handleChange} class="deltoids muscles-helper" id="deltoids" /> <label for="deltoids">Deltoids</label>
  <input type="checkbox" checked={checks.get("forearms")} onChange={handleChange} class="forearms muscles-helper" id="forearms" /> <label for="forearms">Forearms</label>
  <input type="checkbox" checked={checks.get("triceps")} onChange={handleChange} class="triceps muscles-helper" id="triceps" /> <label for="triceps">Triceps</label>
  <h2>Back</h2>
  <input type="checkbox" checked={checks.get("trapezius")} onChange={handleChange} class="trapezius muscles-helper" id="trapezius" /> <label for="trapezius">Trapezius</label>
  <input type="checkbox" checked={checks.get("lats")} onChange={handleChange} class="lats muscles-helper" id="lats" /> <label for="lats">Lats</label>
  <h2>Core</h2>
  <input type="checkbox" checked={checks.get("abs")} onChange={handleChange} class="abs muscles-helper" id="abs" /> <label for="abs">Abs</label>
  <input type="checkbox" checked={checks.get("obliques")} onChange={handleChange} class="obliques muscles-helper" id="obliques" /> <label for="obliques">Obliques</label>
  <input type="checkbox" checked={checks.get("pectorals")} onChange={handleChange} class="pectorals muscles-helper" id="pectorals" /> <label for="pectorals">Pectorals</label>
  <h2>Legs</h2>
  <input type="checkbox" checked={checks.get("adductors")} onChange={handleChange} class="adductors muscles-helper" id="adductors" /> <label for="adductors">Adductors</label>
  <input type="checkbox" checked={checks.get("calves")} onChange={handleChange} class="calves muscles-helper" id="calves" /> <label for="calves">Calves</label>
  <input type="checkbox" checked={checks.get("hamstrings")} onChange={handleChange} class="hamstrings muscles-helper" id="hamstrings" /> <label for="hamstrings">Hamstrings</label>
  <input type="checkbox" checked={checks.get("glutes")} onChange={handleChange} class="glutes muscles-helper" id="glutes" /> <label for="glutes">Glutes</label>
  <input type="checkbox" checked={checks.get("quads")} onChange={handleChange} class="quads muscles-helper" id="quads" /> <label for="quads">Quads</label>
